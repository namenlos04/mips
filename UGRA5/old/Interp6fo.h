/* =========================================================== *\
**  Interp6fo.h -- Описание класса TInterpretator              **
\* =========================================================== */
...
public:
  ...
  int inst_lk(long masinf[], long masadr[], WORD l, WORD n);
  ...
  int outst_lk(long masres[], long masadr[], WORD l, WORD n);
